...
module.exports.validateUser={
  ...
  validateName:check("name").trim().notEmpty().withMessage("Username is required"),
  validateId:check("id").trim().notEmpty("User id is required").isObject("Id should be object")
}

module.exports.checkOneOf ={
    checkOneOf:[this.validateUser.validateEmail.optional(),this.validateUser.validateName.optional()]
}